...
parser.add_argument('--lambda_edge', type=int, default=10, help='weight for edge matching loss')
...
opt = parser.parse_args('--dataset facades --cuda cuda:0 --netG spadeplus --netD multiscale --no_instance'.split())
